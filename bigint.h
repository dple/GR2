...
int BI_set_str(BIGINT rop, const char* str, int base);	/*
														 ...
														 * This function returns 0 if the entire string is a valid number in base base. Otherwise it returns âˆ’1.	
														 */
...
void BI_randb(BIGINT rop, u8 n); 			/* Generate a uniformly distributed random integer in the range 0 to 2^nâˆ’1, inclusive. */
void BI_randm(BIGINT rop, const BIGINT n); 	/* Generate a uniformly distributed random integer in the range 0 to n âˆ’ 1, inclusive. */
